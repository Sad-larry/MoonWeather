 ...
 * 天气预报列表展示适配器
 */
public class DailyAdapter extends BaseQuickAdapter<DailyResponse.DailyDTO, BaseViewHolder> {


    public DailyAdapter(int layoutResId, @Nullable List<DailyResponse.DailyDTO> data) {
